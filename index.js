...
const readFiles =(dirname) => new Promise((resolve, reject) => {
  const promiseArr = [];
     fs.readdirSync(dirname).forEach(filename => {
         promiseArr.push(loadFile(dirname + filename));
     });
...
// let dataStr = `
// type Artwork @cacheControl(maxAge: 10){
//   id: String
//   image: String
//   height_cm: String
//   width_cm: String
...
//   type Lot @cacheControl(maxAge: 10){
//   id: String
//   published: String
//   lot_number: String
//   sp_gbp: String
...
//   type Auction @cacheControl(maxAge: 10){
//   auction_code: String
...
//   type Bibliograhies @cacheControl(maxAge: 10){
//     id: String
//     title: String
//     alias: String
...
//     type Currency @cacheControl(maxAge: 10){
//       id: String
//       name: String
//       alias: String
//       country: String
...
//       type Filmography @cacheControl(maxAge: 10){
//         published: String
...
//         type Language @cacheControl(maxAge: 10){
//         id: String
//         name: String
//         alias: String
//         country: String
...
//         type Genres @cacheControl(maxAge: 10){
//         id: String
//         name: String
//         alias: String
//         }

//         type IntegratedTimelines @cacheControl(maxAge: 10){
//           id: String
//           time_period: String
...
//           type Masterlists @cacheControl(maxAge: 10){
//             name: String
//             id: String
//             alias: String
//             image: String
...
// type Personality @plural(value: "Personality")@cacheControl(maxAge: 10)
// {
// description: String
...
// type Education @cacheControl(maxAge: 10){
// id: String
// start_year: String
// end_year: String
// education: String
...
// type Teaching_Infrastructure @cacheControl(maxAge: 10){
// id: String
// post: String
// data: String
// display_date: String
...
// type Awards @cacheControl(maxAge: 10){
// Exhibition: String
// award_name: String
// id: String
...
// type Projects @cacheControl(maxAge: 10){
//   id: String
//   alias: String
//   name: String
//   display_date: String
...
//   type ResearchCategories @cacheControl(maxAge: 10){
//     id: String
//     abbreviation: String
//     alias: String
//     name: String
...
// type Screening @cacheControl(maxAge: 10){
//   id: String
//   event_name: String
//   type: String
//   sortable_date: String
...
//   type Soundtrack @plural(value: "Soundtrack") @cacheControl(maxAge: 10){
//     id: String
//     name: String
